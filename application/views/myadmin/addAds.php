...
<form action="<?php echo base_url();?>Adminity/Ads/addAds" method="post" enctype="multipart/form-data">   
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="basic-form">
                                            <div class="form-group">
                                                    <label>Ad Name <span class="required">*</span></label>
                                                    <input type="text"  name="ad_name" required="" class="form-control border-none input-flat  bg-ash" placeholder="Ad Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-info btn-lg  border-none sbmt-btn"><i class="ti-save"></i> Add Ads</button>
