                                            ...
                                            <div class="basic-form">
                                                <div class="form-group">
                                                        <div class="user-photo m-b-20">
                                                            <img class="img-responsive" style="width: 250px;" src="<?php echo base_url();?>assets/uploads/profile/<?php echo $row['profile_pic'];?>" onerror="this.onerror=null;this.src='<?php echo base_url();?>mypanel/assets/img/logo.png';" alt="Admin Image Not Set" />
