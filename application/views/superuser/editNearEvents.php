                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card alert">
                                <form action="<?php echo base_url();?>Superuser/nearbyevents/editNearEvents/<?php echo $row['nearbyevent_id'];?>" method="post" enctype="multipart/form-data">   
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="basic-form">
                                            <div class="form-group">
                                                    ...
                                                    <input type="text"  name="summary" value="<?php echo $row['summary'];?>" required=""  maxlength="25" class="form-control border-none input-flat  bg-ash" placeholder="Summary">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-info btn-lg  border-none sbmt-btn"><i class="ti-pencil-alt"></i> Update Near Event</button>
