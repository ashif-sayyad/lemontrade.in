        ...
        <div class="modal-dialog" >
            <div class="modal-content" style="width: 90%;">
                ...
                <div class="modal-header">               
                    ...
                    <h4 class="modal-title"><img style="height: 50px;" src="<?php echo base_url();?>mypanel/assets/img/logo.png"></h4>
                </div>
                
                <div class="modal-body" style="height:550px; overflow:auto;margin-top: -13px;">
